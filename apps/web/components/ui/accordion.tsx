...
>(({ className, ...props }, ref) => (
  <AccordionPrimitive.Item
    ref={ref}
    className={cn("border-b border-fii-navy-100 last:border-b-0", className)}
    {...props}
  />
));
...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    ...
    >
      {children}
      <ChevronDown className="h-4 w-4 shrink-0 text-fii-mute transition-transform duration-200" />
    </AccordionPrimitive.Trigger>
